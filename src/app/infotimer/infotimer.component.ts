...
export class InfotimerComponent {
  // ATTENTION! Date format https://www.w3.org/TR/NOTE-datetime
  // YYYY-MM-DDThh:mm
  ...
  eventsAll: Array<EventObject> = [
    {
      ...
      time: new Date('2020-05-30T10:00')
    },{
      ...
      time: new Date('2020-05-29T07:00')
    },{
      text: 'Två dagar kvar! Förbered dig.',
      textEn: 'Two days left! Get ready.',
      time: new Date('2020-05-28T07:00')
    },{
      text: 'Brutalborg, varför sluta?',
      textEn: 'Brutalborg, why stop?',
      time: new Date('2020-05-02T07:00')
    },{
      text: 'Finalborg',
      textEn: 'Finalborg',
      time: new Date('2020-05-01T07:00')
    },{
      text: 'Save the date 30e Maj!',
      textEn: 'Save the date 30th of May!',
      time: new Date('2020-04-30T16:00')
    },{
      text: 'Valborg',
      textEn: 'Valborg',
      time: new Date('2020-04-30T07:00')
    },{
      text: 'Kvalborg',
      textEn: 'Kvalborg',
      time: new Date('2020-04-29T07:00')
    },{
      text: 'Skvalborg',
      textEn: 'Skvalborg',
      time: new Date('2020-04-28T07:00')
    },{
      text: 'Prevalborg',
      textEn: 'Prevalborg',
      time: new Date('2020-04-27T07:00')
    },{
      ...
      time: new Date('2020-04-23T15:00')
    },{
      ...
      time: new Date('2020-03-13T07:00')
    },{
      text: 'Säkra dina biljetter till Dunderkravallen. Detta vill du inte missa!',
      textEn: 'Get your ticket for Dunderkravallen 2020!',
      time: new Date('2020-02-20T07:00')
    },{
      text: 'Gott nytt år! Karlstads studentliv har mycket att leverera under 2020 inklusive Dunderkravallen, Valborg, Ovveveckan och Campusfesten.',
      textEn: 'Happy new year! Karlstad has a lot to offer. Inkluding Dunderkravallen, Valborg, Ovveveckan and the annual Campus party.',
      time: new Date('2020-01-01T01:00')
    }
  ];
